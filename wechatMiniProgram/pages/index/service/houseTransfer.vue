<template>
	<view class="house-transfer-page">
		<u-navbar title="房屋转让" :titleStyle="titleStyle" placeholder>
...
<script>
	...
	export default {
		...
		onLoad() {
			uni.$on('changeHouseList', this.detailStatus)
		},
		onUnload() {
		...
		methods: {
			...
			handlePublishClick() {
				uni.navigateTo({
					url: "/pages/index/service/modules/houseTransferPublish/houseTransferPublish"
				})
			}
		}
	}
