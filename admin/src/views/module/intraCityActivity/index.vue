<template>
  <div class="container">
    ...
    <el-table v-loading="loading" :data="activityList">
      ...
      <el-table-column label="详细地点" align="center" prop="detailsPlace"/>
      ...
      <el-table-column label="限制人数" align="center" prop="limitPeople"></el-table-column>
      <el-table-column label="开始时间" align="center" prop="startTime"></el-table-column>
      <el-table-column label="截止时间" align="center" prop="endTime"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm('是否确认删除同城活动').then(function () {
        return deleteActivity({id: row.id})
      }).then(() => {
        this.getList()
